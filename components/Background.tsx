  ...
  return (
    <div className="bg-background relative overflow-hidden">
      <div className="h-screen -top-1 flex flex-col bg-background justify-center items-center background-pattern relative overflow-hidden z-10">
        <div className=" background-gradient absolute w-full aspect-square" ref={gradient}></div>
        {props.children}
      </div>

      <div className="background-border absolute w-screen aspect-square" ref={border}></div>
    </div>
  )
}
